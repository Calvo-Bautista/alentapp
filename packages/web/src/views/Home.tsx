...
import { LuUsers, LuLockKeyhole, LuShieldAlert } from "react-icons/lu";
  ...
  return (
    <Box>
      ...
      <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap="8">
        ...
        <SectionCard
          title="Casilleros"
          description="Gestiona el inventario de casilleros, su estado y los socios asignados a cada uno."
          to="/lockers"
          icon={LuLockKeyhole}
        />
        ...
        <SectionCard
          title="Sanciones"
          description="Registra y administra las sanciones disciplinarias aplicadas a los socios del club."
          to="/disciplines"
          icon={LuShieldAlert}
        />
